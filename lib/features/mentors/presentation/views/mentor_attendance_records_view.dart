...
import '../widgets/mentor_attendance_report_tab.dart';

class MentorAttendanceRecordsView extends StatelessWidget {
  final DateTimeRange range;
  final String searchQuery;
  final Function(DateTimeRange) onRangeChanged;

  const MentorAttendanceRecordsView({super.key, required this.range, required this.searchQuery, required this.onRangeChanged});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        const Divider(),
        Expanded(
          child: MentorAttendanceReportTab(searchQuery: searchQuery, startDate: range.start, endDate: range.end),
        ),
      ],
    );
  }
