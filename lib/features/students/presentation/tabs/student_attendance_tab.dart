...
import 'package:gyanshala_app/features/students/presentation/widgets/student_attendance_table.dart';
...
class StudentAttendanceTab extends StatefulWidget {
  ...
  const StudentAttendanceTab({super.key, required this.range, required this.searchQuery, required this.onRangeChanged});

  @override
  State<StudentAttendanceTab> createState() => StudentAttendanceTabState();
}
